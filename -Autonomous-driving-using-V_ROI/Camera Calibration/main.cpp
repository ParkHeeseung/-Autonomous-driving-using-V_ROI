...
int main(int ac, char *av[]){
  ...
  cameraMatrix = (Mat1d(3, 3) << 372.4065453561807, 0, 309.3480413625962, 0, 371.8872781487143, 227.9110967314277, 0, 0, 1);

  distCoeffs = (Mat1d(1, 5) << -0.3071191249576968, 0.1424308416561064, -0.003073071305793751, -0.002662439608671225, -0.03863575710637476);
